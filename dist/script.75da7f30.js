...
var row = document.querySelector("#countries");
...
function formatted(a) {
  var population = '';
  var quotient = Math.floor(a / 1000);
  var rem = a % 1000;
...
function createAndAddCountry(country) {
  ...
  col.className = "col-lg-3 col-sm-12 pr-5";
  ...
  div.innerHTML = "<p class=\"my-0\">Population: ".concat(formatted(population), "</p><p class=\"my-0\">Region: ").concat(region, "</p><p class=\"my-0\">Capital: ").concat(capital, "</p>");
